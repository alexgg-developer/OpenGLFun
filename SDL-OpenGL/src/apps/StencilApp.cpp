...
StencilApp::StencilApp(int width, int height) :
	IApp(width, height)
{
}
...
void StencilApp::handleKeys(unsigned char key, int x, int y)
{
	//Toggle quad
	if (key == 'q')
	{
